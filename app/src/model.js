...
quat.GameInfo.prototype.newPuzzle = function() {
 ...
 */
quat.GameInfo.prototype.getCurrentWord = function() {
	return this.currentSteps[this.currentSteps.length - 1];
}

quat.GameInfo.prototype.getGoal = function() {
	return this.goal;
}
 ...
 */
quat.GameInfo.prototype.getCurrentSteps = function() {
 ...
 */
quat.GameInfo.prototype.goBack = function() {
 ...
 */
quat.GameInfo.prototype.addWord = function(word) {
 ...
 */
quat.GameInfo.prototype.atGoal = function() {
